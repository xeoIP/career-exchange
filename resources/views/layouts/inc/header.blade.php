    ...
    @endif
      ...
      @if (!auth()->user())
			<ul class="responsive float-right">
				<li><a href="{{ lurl('register') }}"><i class="fa fa-user"></i> {{ t('Register') }} </a></li>
				<li><a href="{{ lurl('login') }}"><i class="fa fa-lock"></i>{{ t('Log In') }}</a></li>
			</ul>
      @endif

      @if (auth()->user())
      <ul class="responsive float-right">
        <li><a href="{{ lurl('account') }}"><i class="fa fa-user"></i> {{ t('My Account') }}</a></li>
