...
@if ($xPanel->checkIfFieldIsFirstOfItsType($field, $fields))
	...
	@push('crud_fields_styles')
		...
		<link href="{{ asset('vendor/admin/colorbox/example2/colorbox.css') }}" rel="stylesheet" type="text/css" />
		<style>
	...
	@push('crud_fields_scripts')
		...
		<script src="{{ asset('vendor/admin/colorbox/jquery.colorbox-min.js') }}"></script>
	@endpush
