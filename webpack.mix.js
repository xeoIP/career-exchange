...
mix.js('resources/assets/js/app_bootstrap.js', 'public/js');
mix.sass('resources/assets/sass/app.scss', 'public/css')
    .sass('resources/assets/sass/custom.scss', '../resources/assets/css/custom.css');
...
mix.scripts([
    'resources/assets/js/profilebuilder/step_one.js',
    'resources/assets/js/profilebuilder/step_two.js',
    'resources/assets/js/profilebuilder/step_three.js',
    'resources/assets/js/profilebuilder/step_five.js'
], 'public/js/profile_builder.js');
